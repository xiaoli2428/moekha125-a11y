      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-6">
          <input
            ...
            className="w-full max-w-md px-4 py-2 bg-white/5 border border-white/10 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 text-white placeholder-gray-400"
          />
        </div>
